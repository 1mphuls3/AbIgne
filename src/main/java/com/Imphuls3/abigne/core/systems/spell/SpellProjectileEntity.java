package com.Imphuls3.abigne.core.systems.spell;
...
public abstract class SpellProjectileEntity extends Entity {
    ...
    public Entity shoot(double x, double y, double z, double vx, double vy, double vz, UUID caster, boolean canReturn) {
        setPos(x, y, z);
    ...
    public void tick() {
        ...
        if (!level.isClientSide) {
            HitResult ray = ProjectileUtil.getHitResult(this, (e) -> !e.isSpectator()/* && !e.getUUID().equals(casterId)*/);
