...
public class TransporterRenderer implements BlockEntityRenderer<ItemTransporterBlockEntity> {
    ...
    @Override
    public void render(ItemTransporterBlockEntity blockEntityIn, float partialTicks, PoseStack stackIn, MultiBufferSource bufferIn, int combinedLightIn, int combinedOverlayIn) {
