...
@OnlyIn(Dist.CLIENT)
public class ParticleWisp extends TextureSheetParticle {
    ...
    public ParticleWisp(ClientLevel worldIn, double x, double y, double z, double vx, double vy, double vz, float r, float g, float b, float a, float scale, int lifetime, SpriteSet sprite, boolean disableDepthTest) {
    ...
    public void tick() {
        ...
        this.quadSize = initScale-initScale*lifeCoeff/3;
