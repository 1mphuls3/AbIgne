...
public class FiringBlockRenderer<T extends FiringBlockEntity> implements BlockEntityRenderer<T> {

    public FiringBlockRenderer(BlockEntityRendererProvider.Context context){
    }
