...
public class FlameParticleData implements ParticleProvider<ColorParticleOptions> {
    ...
    public static ParticleOptions createData(Color color) {
        return new ColorParticleOptions(ParticleRegistry.FLAME_TYPE.get(), color, false);
    }

    public static ParticleOptions createData(Color color, boolean disableDepthTest) {
        return new ColorParticleOptions(ParticleRegistry.FLAME_TYPE.get(), color, disableDepthTest, 0.25f, 0.75f, 36);
    }

    public static ParticleOptions createData(Color color, boolean disableDepthTest, float size, float alpha, int age) {
        return new ColorParticleOptions(color, disableDepthTest, size, alpha, age);
    }

    public static ParticleOptions createData(Color color, float size, float alpha, int age) {
        return new ColorParticleOptions(color, false, size, alpha, age);
    }
}
