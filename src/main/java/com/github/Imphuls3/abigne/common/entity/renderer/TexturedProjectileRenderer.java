...
public class TexturedProjectileRenderer<T extends Entity> extends EntityRenderer<T> {
    private ResourceLocation TEXTURE_LOCATION = new ResourceLocation("textures/entity/enderdragon/dragon_fireball.png");
    private RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(TEXTURE_LOCATION);

    public TexturedProjectileRenderer(ResourceLocation TEXTURE_LOCATION, EntityRendererProvider.Context pContext) {
        super(pContext);
