...
public class GeodeFeature {
        ...
        public GeodeFeature(String name, Integer rarityConfig, Integer minYConfig, Integer maxYConfig) {
            NAME = name;
            ...
            GEODE = FeatureUtils.register(name + "_geode", Feature.GEODE, new GeodeConfiguration(
                    new GeodeBlockSettings(BlockStateProvider.simple(Blocks.AIR), SimpleStateProvider.simple(BlockRegistry.PYROLITE_GEM_BLOCK.get()),
                            SimpleStateProvider.simple(BlockRegistry.BUDDING_PYROLITE_GEM_BLOCK.get()), BlockStateProvider.simple(BlockRegistry.BLACK_CALCITE_BRICKS.get()),
