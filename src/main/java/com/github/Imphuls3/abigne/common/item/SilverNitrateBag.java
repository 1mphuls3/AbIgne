...
import com.github.Imphuls3.abigne.common.entity.SilverNitrateExplosive;
...
public class SilverNitrateBag extends Item {

    public SilverNitrateBag(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (!level.isClientSide) {
            ...
            level.addFreshEntity(new SilverNitrateExplosive(EntityRegistry.SILVER_EXPLOSIVE.get(), level)
                    .shoot(pos.x, pos.y, pos.z, vel.x, vel.y, vel.z, player.getUUID()
                    ));
